                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('type') is-invalid @enderror"
                                    ...
                                    <option value="1" {{old('type', $brand->type) == 1 ? 'selected' : ''}}>{{__('labels.smartphone')}}</option>
                                    <option value="2" {{old('type', $brand->type) == 2 ? 'selected' : ''}}>{{__('labels.phone-plan')}}</option>
                                    <option value="3" {{old('type', $brand->type) == 3 ? 'selected' : ''}}>{{__('labels.energy-plan')}}</option>
                                </select>
                                @error('type')
