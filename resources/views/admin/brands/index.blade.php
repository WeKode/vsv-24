...
@section('title',trans_choice('labels.brand',3))
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{trans_choice('labels.brand',3)}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__("labels.dashboard")}}</a></li>
                            <li class="breadcrumb-item active">{{__("labels.list",['name' => trans_choice('labels.brand',3)])}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5">
                        <div class="card card-primary col-md-12">
                            <div class="card-header">
                                <h3 class="card-title">{{__('actions.add-new',['name' => trans_choice('labels.brand',1)])}}</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{__("labels.list",['name' => trans_choice('labels.brand',3)])}}</h3>
                            </div>

                            <!-- /.card-header -->
                            <div class="card-body">
                                    <div class="card-tools">
{{--                                        <a class="btn btn-sm btn-info" href="{{route('admin.brands.create')}}">--}}
...
{{--                                        </a>--}}
                                ...
                                <table id="datatable" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.brands.edit',$b->id)}}" class="btn btn-sm btn-warning">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" onclick="deleteItem({{$b->id}})" class="btn btn-sm btn-danger">
