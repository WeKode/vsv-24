...
@section('title',__('actions.add-new',['name' => trans_choice('labels.image',1)]))
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.images.index')}}">{{ trans_choice('labels.image',3)}}</a></li>
                            <li class="breadcrumb-item active">{{__("actions.add-new",['name' => trans_choice('labels.image',1)])}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                    ...
                                    <option value="1"
                                        {{old('type') == 1 ? 'selected' : ''}}>{{trans_choice('labels.image',1)}}</option>
                                    <option value="2"
                                        {{old('type') == 2 ? 'selected' : ''}}>{{__('labels.logo')}}</option>
                                </select>
                                @error('type')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
