...
@section('title',trans_choice('labels.user',3))
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{trans_choice('labels.user',3)}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
{{--                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__("labels.dashboard")}}</a></li>--}}
                            <li class="breadcrumb-item active">{{__("labels.list",['name' => trans_choice('labels.user',3)])}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{__("labels.list",['name' => trans_choice('labels.user',3)])}}</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.users.edit',$a->id)}}" class="btn btn-sm btn-warning">
