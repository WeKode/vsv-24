...
@section('title',__('actions.add-new',['name' => trans_choice('labels.category',1)]))
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{__("actions.add-new",['name' => trans_choice('labels.category',1)])}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
