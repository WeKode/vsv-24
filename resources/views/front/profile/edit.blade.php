                            ...
                            <form class="row" method="post" action="{{route('profile.update')}}">
                                ...
                                <div class="col-12 pe-lg-2 px-0 mb-3">
                                    ...
                                    <input type="file" name="pic"
                                           class="form-control @error('pic') py-3" id="profile_picture">
                                    @error('pic')
                                ...
                                <div class="col-lg-6 pe-lg-2 px-0 mb-3">
                                    ...
                                    <input type="text" value="{{user()->first_name}}" class="form-control @error('first_name') is-invalid @enderror py-3" id="first_name" placeholder="{{__('labels.first_name')}}">
                                    @error('first_name')
                                    <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-3 ps-lg-2 px-0 mb-3">
                                    <label for="city" class="form-label ">{{__('labels.city')}}</label>
                                    <select type="text" name="city"   class="form-select @error('city') is-invalid @enderror py-3" id="city">
                                        <option value="1" disabled selected>{{__('labels.select_item',['name' => __('labels.city')])}}</option>
                                    </select>
                                    @error('city')
                                    <div class="invalid-feedback">{{$message}}</div>
                                    @enderror                                </div>
